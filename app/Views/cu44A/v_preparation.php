                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('cu44A') ?>">CU 44A</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <form action="/cu44A/prepare" method="POST" class="mx-3 py-2">
                                    <?= csrf_field() ?>
                                    ...
                                    <div class="mb-2 py-2 mx-2">
                                        ...
                                        <a href="<?= route_to('cu44A') ?>" class="btn btn-ligth text-warning ml-1">&laquo; Back</a>
                                    </div>
