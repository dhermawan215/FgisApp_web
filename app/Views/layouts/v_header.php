...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?= base_url() ?>/Backend/assetsx/css/adminlte.min.css">
    <!-- SweetAlert2 -->
    <link rel="stylesheet" href="<?= base_url() ?>/Backend/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    <!-- Toastr -->
